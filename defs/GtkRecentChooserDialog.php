<?php
	...
	return [
		...
		'configs' => [
			'cpp-object' => "GtkRecentChooserDialog",
			'name' => "GtkRecentChooserDialog_",
			'extends' => "GtkDialog_",
			'cast_macro' => "GTK_RECENT_CHOOSER_DIALOG"
		],
		...
		'methods' => [
			'__construct' => [
				'cpp-method' => "gtk_recent_chooser_dialog_new",
				'static' => FALSE,
				'return-type' => NULL,
				'parameters' => [
					[
			...
			//--------------
			'new_for_manager' => [
				'cpp-method' => "gtk_recent_chooser_dialog_new_for_manager",
				'static' => FALSE,
			...
			'get_sort_type' => [
				...
				'static' => FALSE,
				'return-type' => "enum GtkRecentSortType",
				'parameters' => NULL
			],
